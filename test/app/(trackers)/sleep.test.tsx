...
describe("Track sleep screen", () => {
    ...
    test("Catch missing inputs", async () => {
        ...
        expect((Alert.alert as jest.Mock).mock.calls[0][1])
            .toBe("Failed to save the Sleep log. Please provide either a stopwatch time or manual start and end times.");
    });
    ...
    test("Catch getActiveChildData() error (stopwatch)", async () => {
        ...
        // error message generated by app/library/utils.ts -> getActiveChildData()
    ...
    test("Catch getActiveChildData() error (manual time)", async () => {
        const testErrorMessage = "testErrorInsert";
