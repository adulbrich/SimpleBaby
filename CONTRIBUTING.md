...
Your database is now set up with the applied tables! Now, you will need to make some minor changes to the project settings to make it compatible with the current status of the SimpleBaby app.

First, go to the left sidebar menu and click on Authentication. Under Configuration, click on 'Sign In / Providers.' Then, uncheck the 'Confirm Email' option and press the green 'Save changes' button.
